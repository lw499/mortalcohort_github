...
gendata = function(N) {
  ...
  #p01=-2.83261; p11=0.18151; p21=-0.32490; p31=0.95201; p41=1.11041; p51=1.56441;
  #p02=-5.43655; p22=0.26892; p32=0.22023; p42=1.81943; p52=2.21425;
  #p03=-2.17685; p33=0.14425; p43=0.38340; p53=1.42730;
  ...
  #dat$dop2 = EXPIT(p01+p11*dat$y1+p21*sex+p31*I(s1==4)+p41*I(s1==6)+p51*I(s1==8) )
  #dat$dop3 = EXPIT(p02+p22*dat$y2+p32*sex+p42*I(s1==6)+p52*I(s1==8)  )
  #dat$dop4 = EXPIT(p03+p33*dat$y3+p43*sex+p53*I(s1==8)  )
  #dat$dop5 = EXPIT(p04+p44*dat$y4+p54*sex)  
  dat$tmpd0=1;
